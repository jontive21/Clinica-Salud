...
// GET /:id/editar - Mostrar formulario para editar un ala
router.get('/:id/editar', AlaController.mostrarFormularioEditar);

// POST /:id/actualizar - Actualizar un ala
router.post('/:id/actualizar', AlaController.actualizarAla);

// POST /:id/eliminar - Eliminar un ala
router.post('/:id/eliminar', AlaController.eliminarAla);
